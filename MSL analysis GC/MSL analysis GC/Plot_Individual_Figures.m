...
[seq_results(1,1).media_MicroMogs_acum,seq_results(1,1).media_MicroMongs_acum]=MeanMicroMicro_Gains_Plot_Indivudual(seq_results(1,1).media_MicroMogs,seq_results(1,1).media_MicroMongs,seq_results(1,1).std_MicroMogs,seq_results(1,1).std_MicroMongs,'Mean');
...
%GC 6/9/23
[seq_results(1,1).mediana_MicroMogs_acum,seq_results(1,1).mediana_MicroMongs_acum]=MeanMicroMicro_Gains_Plot_Indivudual(seq_results(1,1).mediana_MicroMogs,seq_results(1,1).mediana_MicroMongs,seq_results(1,1).std_MicroMogs,seq_results(1,1).std_MicroMongs,'Median');
